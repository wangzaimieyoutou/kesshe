        ...
        <div class="row">
            <div class="col-md-12 col-sm-3">
                <div class="panel panel-default">
                    ...
                    <form id="form" action="${pageContext.request.contextPath}/course?method=delSelectedClassNo" method="post">
                            ...
                            <c:forEach items="${pb.list}" var="course" varStatus="s">
					            <tr>
					                ...
					                <td><a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/course?method=findCourse&id=${course.id}">修改</a>&nbsp;
					                    <a class="btn btn-default btn-sm" href="javascript:deleteCourse(${course.id});">删除</a></td>
					            </tr>
					        </c:forEach>
                        </table>
                        </form>
                        ...
                        <nav aria-label="Page navigation" class="pull-right">
                            <ul class="pagination" style="margin-top: 10px;">
				                ...
				                <c:if test="${pb.currentPage != 1}">
				                    ...
				                    <a href="${pageContext.request.contextPath}/course?method=findAll&currentPage=${pb.currentPage - 1}&rows=5" aria-label="Previous">
				                ...
				                <c:forEach begin="1" end="${pb.totalPage}" var="i" >
				                    ...
				                    <c:if test="${pb.currentPage == i}">
				                        <li class="active"><a href="${pageContext.request.contextPath}/course?method=findAll&currentPage=${i}&rows=5">${i}</a></li>
				                    </c:if>
				                    <c:if test="${pb.currentPage != i}">
				                        <li><a href="${pageContext.request.contextPath}/course?method=findAll&currentPage=${i}&rows=5">${i}</a></li>
				                    </c:if>
				
				                </c:forEach>
				
				                <li>
				                    <a href="${pageContext.request.contextPath}/course?method=findAll&currentPage=${pb.currentPage + 1}&rows=5" aria-label="Next">
