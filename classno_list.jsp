            ...
            <div class="col-md-12 col-sm-3">
                <div class="panel panel-default">
				    ...
				    <div style="float: right;margin: 5px;">
				        ...
				        <a class="btn btn-primary" href="javascript:void(0);" id="delSelectedClassNo">删除选中</a>
                            ...
                            <c:forEach items="${pb.list}" var="classNo" varStatus="s">
					            <tr>
					                ...
					                <td><a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/classno?method=findClassNo&id=${classNo.id}">修改</a>&nbsp;
					                    <a class="btn btn-default btn-sm" href="javascript:deleteClassNo(${classNo.id});">删除</a></td>
					            </tr>
                        ...
                        <nav aria-label="Page navigation" class="pull-right">
                            <ul class="pagination" style="margin-top: 10px;">
				                ...
				                <c:if test="${pb.currentPage != 1}">
                                    ...
                                    <%--当前页--%>
				                    <a href="${pageContext.request.contextPath}/classno?method=findAll&currentPage=${pb.currentPage - 1}&rows=5" aria-label="Previous">
				                ...
				                <c:forEach begin="1" end="${pb.totalPage}" var="i" >
				                    ...
				                    <c:if test="${pb.currentPage == i}">
				                        <li class="active"><a href="${pageContext.request.contextPath}/classno?method=findAll&currentPage=${i}&rows=5">${i}</a></li>
				                    </c:if>
				                    <c:if test="${pb.currentPage != i}">
				                        <li><a href="${pageContext.request.contextPath}/classno?method=findAll&currentPage=${i}&rows=5">${i}</a></li>
				                    </c:if>
				
				                </c:forEach>
				                <%--下一页--%>
				                <li>
				                    <a href="${pageContext.request.contextPath}/classno?method=findAll&currentPage=${pb.currentPage + 1}&rows=5" aria-label="Next">
